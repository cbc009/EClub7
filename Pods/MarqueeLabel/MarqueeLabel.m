    ...
    switch (self.marqueeType) {
        ...
        case MLContinuousReverse:
        {
            ...
            if (self.marqueeType == MLContinuous) {
                ...
                awayLabelOffset = -(self.homeLabelFrame.size.width + self.fadeLength + self.continuousMarqueeExtraBuffer);
...
- (void)setContinuousMarqueeExtraBuffer:(CGFloat)continuousMarqueeExtraBuffer {
    ...
    _continuousMarqueeExtraBuffer = (CGFloat)fabs(continuousMarqueeExtraBuffer);
    [self updateSublabelAndLocations];
}
