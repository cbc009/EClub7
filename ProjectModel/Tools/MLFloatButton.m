...
-(void)setFloatButtonInViewController:(UIViewController<MLFloatButtonDelegate> *)viewController{
    self.floatButtonDelegate = viewController;
    [viewController.view addSubview:self];
    self.fatherView = viewController.view;
}

+(MLFloatButton *)loadFromNibAddTarget:(id)target InSuperView:(UIView *)superView{
...
+(MLFloatButton *)loadFromNibWithFrame:(CGRect)frame addTarget:(id)target InSuperView:(UIView *)superView{
    MLFloatButton *button = [MLFloatButton loadFromNibAddTarget:target InSuperView:superView];
