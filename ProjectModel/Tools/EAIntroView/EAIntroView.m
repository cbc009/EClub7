...
- (void)buildFooterView {
    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - self.pageControlY+15, self.frame.size.width, 20)];
    [self.pageControl setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
    self.pageControl.currentPageIndicatorTintColor=[SharedAction colorWithHexString:@"#eb96bf"];
    self.pageControl.pageIndicatorTintColor =[SharedAction colorWithHexString:@"#ffebd4"];
    ...
    self.skipButton = [[UIButton alloc] initWithFrame:CGRectMake(self.scrollView.frame.size.width/2-40, self.pageControl.frame.origin.y+15, 80, 20)];
